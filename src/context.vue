  ...
  <div class="context">
    <div class="header" ref="header">
      <div class="title" @click="Goback">
        <div class="FirstTitle">Shinkansen</div>
        <div class="SecondTitle">Exhibition</div>
      </div>
      <div class="otherfunctions">
        <div class="ExceptNavigation">
          <a
            class="ExceptNavigation_First"
            href="https://shop.sciencemuseum.org.uk/collections/national-railway-museum"
            target="_blank"
          >
          ...
          <a
            class="ExceptNavigation_First last"
            href="https://www.railwaymuseum.org.uk/search"
            target="_blank"
          >
